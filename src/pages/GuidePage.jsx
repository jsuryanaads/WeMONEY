...
import { BookOpen, ChevronDown, HelpCircle, Wallet, ArrowRightLeft, ShieldCheck, UserX, AlertTriangle } from 'lucide-react'
...
export default function GuidePage() {
  ...
  return <AppShell title="Panduan WeMoney"><div className="grid gap-4 sm:gap-6 lg:grid-cols-[1.3fr_.7fr]">
