...
export default function Register() {
  ...
  return <AuthShell title="Buat akun" subtitle="Mulai mencatat keuanganmu hari ini.">
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <label className="block"><span className="text-sm font-semibold">Kata sandi</span><input required minLength={8} type="password" autoComplete="new-password" value={form.password} onChange={(e)=>change('password',e.target.value)} className="mt-1.5 w-full rounded-xl border border-slate-200 px-4 py-3 outline-none focus:border-blue-500" placeholder="Minimal 8 karakter" /></label>
