...
function confidenceLabel(value) {
  ...
  if (value >= 0.7) return 'Saran'
  if (value >= 0.5) return 'Perlu dicek'
  return 'Pilih manual'
}
...
export default function QuickExpense({ open, onClose }) {
  ...
  function changeType(id, type) {
    setItems(current => current.map(item => item.id === id ? { ...item, type, categoryId: '', classificationConfidence: 0, classificationSource: 'manual', classificationExplanation: 'Jenis diubah. Pilih kategori secara manual.' } : item))
  }
